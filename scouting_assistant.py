...
if choose == "Análise Individual":
    ...
    if jogadores:
        ...
        if posição == ("R/L BACK"):
            ...
            # Plot the second scatter plot in the second subplot
            ax9.scatter(metrics_providing_teammates, metrics_y, color='deepskyblue', label='Outros jogadores da Liga')
...
##########################################################################################################################
        ...
        if posição == ("DEFENCE"):
            ...
            # Plot the second scatter plot in the second subplot
            ax9.scatter(metrics_progression, metrics_y, color='deepskyblue', label='Outros jogadores da Liga')
...
##########################################################################################################################
        ...
        if posição == ("WINGER"):
            ...
            # Plot the second scatter plot in the second subplot
            ax8.scatter(metrics_box_threat, metrics_y, color='deepskyblue', label='Outros jogadores da Liga')
            ...
            # Plot the second scatter plot in the second subplot
            ax9.scatter(metrics_finishing, metrics_y, color='deepskyblue', label='Outros jogadores da Liga')
...
##########################################################################################################################
        ...
        if posição == ("STRIKER"):
            ...
            # Plot the second scatter plot in the second subplot
            ax7.scatter(metrics_finishing, metrics_y, color='deepskyblue', label='Outros jogadores da Liga')
            ...
            # Plot the second scatter plot in the second subplot
            ax8.scatter(metrics_poaching, metrics_y, color='deepskyblue', label='Outros jogadores da Liga')
...
#####################################################################################################################            
            ...
            #genai.configure(api_key="AIzaSyD76jMkKPAlBeF8YKGrsKRCAwf0nxovpAM")
...
##########################################################################################################################
        ...
        if posição == ("MIDFIELDER"):
            ...
            # Plot the second scatter plot in the second subplot
            ax7.scatter(metrics_providing_teammates, metrics_y, color='deepskyblue', label='Outros jogadores da Liga')
